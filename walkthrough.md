...
```
+-----------------------------------------------------------------------------------+
| [SIH26170 Drishti] [Home] [Breakdown] [Leakage IV] [Turn-On] [About]|
+-----------------------------------------------------------------------------------+
...
2. **Move & Adjust Graphs Directly According to Your Needs**:
 ...
 - ** Pan the View**: Click the ` Pan View` button in the chart header and drag the chart to slide the axes left, right, up, or down.
 ...
 - ** Real-Time Sliders**: Use the smooth range sliders for Input Voltage (V) and Measured Current (A) to slide values and watch the test point glide across the curves.
...
## 7. Team Details — Team Drishti (Insightful Vision)
